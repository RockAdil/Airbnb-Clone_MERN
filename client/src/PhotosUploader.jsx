          ...
          addPhotos.map((link, index) => (
            <div key={index} className='h-40 flex relative'>
              ...
              <button
                ...
                className='absolute bottom-1 right-1 text-white bg-black bg-opacity-50 p-2 cursor-pointer rounded-md'
              >
                <svg
              ...
              <button
                ...
                className='absolute bottom-1 left-1 text-white bg-black bg-opacity-50 p-2 cursor-pointer rounded-md'
              >
                {link === addPhotos[0] ? (
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
